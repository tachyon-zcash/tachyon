...
#[must_use]
pub(crate) fn anchor_stamp_step(prev: Fp, update: Coordinates<EqAffine>) -> Fp {
...
#[must_use]
pub(crate) fn anchor_empty_step(prev: Fp) -> Fp {
    hash::<2>([
...
#[must_use]
pub(crate) fn anchor_epoch_step(prev: Fp, new_epoch: u32) -> Fp {
    hash::<3>([
