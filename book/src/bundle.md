...
- `sig` - a 64-byte RedPallas[^redpallas] signature by `rk` over the transaction-wide sighash
...
- `binding_sig` - signature over the transaction-wide sighash (same digest as action sigs)
