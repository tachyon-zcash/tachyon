...
$$
\mathsf{tg} = \mathsf{nf}_e = M_e + \mathsf{cm}
$$
...
[^nullifiers]: See [Nullifiers](./nullifiers.md) for the pronullifier polynomial $M$ and the shift $\mathsf{nf}_e = M_e + \mathsf{cm}$.
