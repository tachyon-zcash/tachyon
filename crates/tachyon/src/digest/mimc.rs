...
//! [`ExpandedKeySchedule`](crate::keys::ExpandedKeySchedule), feeding the secret
...
/// ends).
#[must_use]
pub(crate) fn schedule_key(round_keys: &[Fp; MK_LENGTH], input: Fp, whitening: Fp) -> Fp {
